//! Special types that allow operations with any types as long as correct conversions are possible.
...
/// Same as a [int](crate::int) but enables operations with other types ([uint](crate::uint), [rational](crate::rational), ...)
///
